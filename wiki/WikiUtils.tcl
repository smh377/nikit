package provide WikiUtils 1.0.0

# Wiki database code uses [dict get?]
...
namespace ensemble configure dict -map [dict replace [namespace ensemble configure dict -map] get? ::tcl::dict::get?]

# Helper function to pass method to callback

proc oo::Helpers::mycode {args} {
    list namespace inscope [uplevel 1 {namespace current}] [linsert $args 0 my]
}

# Wiki formatting code uses the following armour functions:
